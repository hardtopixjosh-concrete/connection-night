          ...
          <Card className="bg-gradient-to-br from-zinc-900 to-zinc-900 border-amber-900/30 relative">
            ...
            {isEditingVault ? (
                <div className="space-y-3 animate-in fade-in">
                    <div><label className="text-[10px] font-black text-zinc-500 uppercase">Goal Name</label><input className="w-full bg-zinc-950 border border-zinc-800 rounded p-2 text-white text-xs" value={editVaultName} onChange={e => setEditVaultName(e.target.value)} /></div>
                    <div><label className="text-[10px] font-black text-zinc-500 uppercase">Target Amount</label><input type="number" className="w-full bg-zinc-950 border border-zinc-800 rounded p-2 text-white text-xs" value={editVaultGoal} onChange={e => setEditVaultGoal(e.target.value)} /></div>
        ...
        <div className="space-y-6">
          <Card title="Add Custom Reward">
             <div className="flex gap-2">
                ...
                <button onClick={handleAddItem} className={`${theme.solid} ${theme.hover} text-white p-3 rounded-xl transition-colors`}><Plus size={18} /></button>
             </div>
          </Card>
